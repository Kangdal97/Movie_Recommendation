...
class Exam(QWidget, form_window):
    def __init__(self):
        ...
        self.setupUi(self)
        # 파일로드
        self.df_reviews = pd.read_csv('./crawling/cleaned_review_2015-2021.csv')
        self.Tfidf_matrix = mmread('./models/Tfidf_movie_review.mtx').tocsr()
        self.embedding_model = Word2Vec.load('./models/word2VecModel_2015-2021.model')
        with open('./models/tfid.pickle', 'rb') as f:
    ...
    def getRecommendation(self, cosine_sim):  # 검색창
    ...
    def btn_recommend_slot(self):  # 버튼시그널
            ...
            if key_word in self.titles:
                ...
                if len(key_word) > 10:
                    ...
                    try:
                        ...
                        self.lbl_recommend.setText('제가 아직 모르는 단어에요 ㅠㅠ')
                        return
                    words = []
