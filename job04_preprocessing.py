...
df = pd.read_csv('./crawling/naver_movie_reviews_onesentence_2015_2021.csv')
print(df.head())
df.info()

df2 = pd.read_csv('./crawling/cleaned_review_2015_2021.csv')
...
df2.to_csv('./crawling/cleaned_review_2015_2021.csv', index=False)
# exit()
okt = Okt()
...
df.to_csv('./crawling/cleaned_review_2015_2021.csv', index=False)
